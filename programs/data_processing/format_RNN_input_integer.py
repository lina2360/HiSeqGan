...
df_source['clustered_label'] = df_source['clustered_label']*pow(10,layer)
...
result.to_csv('./applications/%s/data/tmp_integer.csv' % (prefix), index=False)


df = pd.read_csv('./applications/%s/data/tmp_integer.csv' % (prefix), low_memory=False)
print(df.columns)
